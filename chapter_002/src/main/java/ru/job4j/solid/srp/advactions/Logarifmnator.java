 ...
 * @since 04.06.2019
 */
public class Logarifmnator implements UserAction {
    ...
    /**
     * Метод выполняет вычисление натурального логарифма.
     *
    ...
    @Override
    public String info() {
        return String.format("%s. %s", this.key(), "Get logn.");
    }
}
